...
export default function AdminPage() {
  ...
  const handleQuizSave = () => {
    // In a real app you’d refetch quizzes, for now we just close the modal
    setIsFormOpen(false)
  }
      ...
      <div className="space-y-6">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Select a date to edit an existing quiz or create a new one.
                  </CardDescription>
                </div>
        ...
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Use this form to configure the daily or mega quiz.
            </DialogDescription>
          </DialogHeader>
